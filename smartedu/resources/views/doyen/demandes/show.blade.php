...
<div class="main-wrapper">
    ...
    <div class="page-wrapper">
        <div class="content container-fluid">
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-auto">
                        @if($demande->statut === 'traitee')
                            <a class="btn btn-outline-success" href="{{ route('doyen.demandes.download', $demande) }}">
            ...
            <div class="card">
                <div class="card-body">
                    <form method="POST" action="{{ route('doyen.demandes.update', $demande) }}">
                        @csrf @method('PUT')
                        <div class="row g-3">
                            <div class="col-md-4">
                            ...
                            <div class="col-12">
                                <label class="form-label">Réponse / contenu</label>
                                <textarea name="reponse" rows="6" class="form-control">{{ old('reponse', $demande->reponse) }}</textarea>
                            </div>
                        </div>
                        <div class="mt-3 d-flex gap-2">
                            <a href="{{ route('doyen.demandes.index') }}" class="btn btn-secondary">Retour</a>
