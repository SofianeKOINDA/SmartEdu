        ...
        <div class="content container-fluid">
            ...
            <div class="page-header">
                <div class="row align-items-center">
                    <div class="col">
                        <h3 class="page-title">Créer une filière</h3>
                    </div>
                </div>
            </div>
            ...
            <div class="card">
                <div class="card-body">
                    <form method="POST" action="{{ route('chef_departement.filieres.store') }}">
                        @csrf
                        <div class="row g-3">
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="number" name="duree_annees" class="form-control" value="{{ old('duree_annees', 3) }}" min="1" max="10" required>
                            </div>
                        </div>
