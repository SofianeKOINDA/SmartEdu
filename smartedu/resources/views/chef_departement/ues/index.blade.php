        ...
        <div class="content container-fluid">
            ...
            <div class="page-header">
                <div class="row align-items-center">
                    ...
                    <div class="col-auto">
                        <a class="btn btn-primary" href="{{ route('chef_departement.ues.create') }}">
                            ...
                            <tbody>
                                @forelse($ues as $ue)
                                    <tr>
                                        ...
                                        <td class="text-end">
                                            <a class="btn btn-sm btn-outline-primary" href="{{ route('chef_departement.ues.edit', $ue) }}">Modifier</a>
                                        </td>
                                    </tr>
                                @empty
