...
<div class="main-wrapper">
    ...
    <div class="page-wrapper">
        <div class="content container-fluid">
            ...
            <div class="card">
                <div class="card-body">
                    <form method="POST" action="{{ route('chef_departement.cours.store') }}">
                        @csrf
                        <div class="row g-3">
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                ...
                                <input name="intitule" class="form-control" value="{{ old('intitule') }}" required>
                            </div>
                            <div class="col-md-6">
                            ...
                            <div class="col-md-4">
                                ...
                                <input name="volume_horaire" type="number" class="form-control" value="{{ old('volume_horaire', 0) }}" min="0" required>
                            </div>
                        </div>
