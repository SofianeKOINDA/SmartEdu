        ...
        <div class="content container-fluid">
            ...
            <div class="page-header">
                <div class="row align-items-center">
                    ...
                    <div class="col-auto">
                        <a class="btn btn-primary" href="{{ route('chef_departement.etudiants.create') }}">
                            ...
                            <tbody>
                                @forelse($etudiants as $e)
                                    <tr>
                                        ...
                                        <td class="text-end">
                                            <a class="btn btn-sm btn-outline-secondary" href="{{ route('chef_departement.etudiants.show', $e) }}">Détail</a>
                                            <a class="btn btn-sm btn-outline-primary" href="{{ route('chef_departement.etudiants.edit', $e) }}">Modifier</a>
                                        </td>
                                    </tr>
                                @empty
