  ...
  <div class="header">
        ...
        <div class="header-left">
            ...
            <a href="index.html" class="logo logo-small">
                <img src="templates/assets/img/logo-small.png" alt="Logo" width="30" height="30">
            </a>
        </div>
        ...
        <ul class="nav user-menu">
            ...
            <li class="nav-item dropdown language-drop me-2">
                <a href="#" class="dropdown-toggle nav-link header-nav-list" data-bs-toggle="dropdown">
                    <img src="templates/assets/img/icons/header-icon-01.svg" alt="">
                </a>
            ...
            <li class="nav-item dropdown noti-dropdown me-2">
                <a href="#" class="dropdown-toggle nav-link header-nav-list" data-bs-toggle="dropdown">
                    <img src="templates/assets/img/icons/header-icon-05.svg" alt="">
                </a>
                            ...
                            <li class="notification-message">
                                <a href="#">
                                    <div class="media d-flex">
                                        <span class="avatar avatar-sm flex-shrink-0">
                                            <img class="avatar-img rounded-circle" alt="User Image"
                                                src="templates/assets/img/profiles/avatar-17.jpg">
                                        </span>
                                        <div class="media-body flex-grow-1">
                                            <p class="noti-details">
                                                <span class="noti-title">John Hendry</span>
                            ...
                            <li class="notification-message">
                                <a href="#">
                                    <div class="media d-flex">
                                        <span class="avatar avatar-sm flex-shrink-0">
                                            <img class="avatar-img rounded-circle" alt="User Image"
                                                src="templates/assets/img/profiles/avatar-13.jpg">
                                        </span>
                                        <div class="media-body flex-grow-1">
                                            <p class="noti-details">
            ...
            <li class="nav-item zoom-screen me-2">
                <a href="#" class="nav-link header-nav-list">
                    <img src="templates/assets/img/icons/header-icon-04.svg" alt="">
                </a>
            </li>
            ...
            <li class="nav-item dropdown has-arrow new-user-menus">
                <a href="#" class="dropdown-toggle nav-link" data-bs-toggle="dropdown">
                    <span class="user-img">
                        <img class="rounded-circle" src="templates/assets/img/profiles/avatar-01.jpg"
